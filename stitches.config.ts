...
export const { styled, css, globalCss, keyframes, getCssText, theme, createTheme, config } =
   createStitches({
      ...
      utils: {
         px: (space: Stitches.ScaleValue<"space"> | `${number}px`) => ({
            paddingLeft: space,
            paddingRight: space
         }),
         py: (space: Stitches.ScaleValue<"space"> | `${number}px`) => ({
            paddingTop: space,
            paddingBottom: space
         }),
         mx: (space: Stitches.ScaleValue<"space"> | `${number}px`) => ({
            marginLeft: space,
            marginRight: space
         }),
         my: (space: Stitches.ScaleValue<"space"> | `${number}px`) => ({
            marginTop: space,
            marginBottom: space
         }),
